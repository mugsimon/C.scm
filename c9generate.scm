...
(define (c9symbol-fun fun args r)
  ...
  (cond ((assq fun c9*primitive*)
        ...
        ((or (cscm:var? fun)
             (c9anf? fun))
         (let ((n (length args))
               (name (if (cscm:var? fun)
                         (var-name fun)
                         fun)))
           (case n
             ((0) (c9display "CSCM_APPLY0(" name))
             ((1) (c9display "CSCM_APPLY1(" name)
              (c9args args r))
             ((2) (c9display "CSCM_APPLY2(" name)
              (c9args args r))
             ((3) (c9display "CSCM_APPLY3(" name)
              (c9args args r))
             ((4) (c9display "CSCM_APPLY4(" name)
              (c9args args r))
             ((5) (c9display "CSCM_APPLY5(" name)
              (c9args args r))
             ((6) (c9display "CSCM_APPLY6(" name)
              (c9args args r))
             ((7) (c9display "CSCM_APPLY7(" name)
              (c9args args r))
             ((8) (c9display "CSCM_APPLY8(" name)
              (c9args args r))
             ((9) (c9display "CSCM_APPLY9(" name)
              (c9args args r))
             ((10) (c9display "CSCM_APPLY10(" name)
              (c9args args r))
             (else
         ...
         (let ((n (length args))
           ...
           (case n
             ...
             ((1) (c9display "CSCM_APPLY1(CSCM_GVREF(")
              (c9write fun-str) (c9display ")") (c9args args r))
...
(define (c9symbol x r)
  ...
  (cond ((cscm:var? x)
         ...
         #;(if (null? (var-local-fun-args x))
             (c9display (var-name x))
             (begin (c9display "CSCM_GVREF(")
                    (c9write (symbol->string (var-name x)))
                    (c9display ")"))))
        ((c9anf? x)
         (c9display x))
        (else
